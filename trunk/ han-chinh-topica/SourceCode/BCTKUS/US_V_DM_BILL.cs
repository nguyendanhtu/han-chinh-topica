...
#region "Init Functions"
    ...
    public void FillDatasetSearch_bitralai_user(DataSet ip_ds, decimal ip_dc_id_trang_thai, DateTime ip_dat_tu_ngay, DateTime ip_dat_den_ngay)
    {
        CStoredProc v_store_proc = new CStoredProc("pr_V_DM_BILL_Search_trang_thai_tra_lai_user");
        v_store_proc.addDecimalInputParam("@ID_TRANG_THAI", ip_dc_id_trang_thai);
        v_store_proc.addDatetimeInputParam("@TU_NGAY", ip_dat_tu_ngay);
        v_store_proc.addDatetimeInputParam("@DEN_NGAY", ip_dat_den_ngay);
        v_store_proc.fillDataSetByCommand(this, ip_ds);
    ...
    public void Fill_DS_BAO_CAO_TONG_HOP_BILL_BI_TRA_LAI_KHONG_MAT_PHI_WEB_DETAIL(DS_V_DM_BILL ip_v_ds_v_dm_bill, decimal ip_dc_id_trung_tam, DateTime ip_v_dat_tu_ngay, DateTime ip_v_dat_den_ngay)
    {
        CStoredProc v_store_proc = new CStoredProc("pr_BAO_CAO_TONG_HOP_BILL_BI_TRA_LAI_KHONG_MAT_PHI_WEB_DETAIL");
        v_store_proc.addDecimalInputParam("@ID_TRUNG_TAM", ip_dc_id_trung_tam);
        v_store_proc.addDatetimeInputParam("@TU_NGAY", ip_v_dat_tu_ngay);
        v_store_proc.addDatetimeInputParam("@DEN_NGAY", ip_v_dat_den_ngay);
        v_store_proc.fillDataSetByCommand(this, ip_v_ds_v_dm_bill);
    ...
    public void Fill_DS_BAO_CAO_TONG_HOP_BILL_BI_TRA_LAI_MAT_PHI_WEB_DETAIL(DS_V_DM_BILL ip_v_ds_v_dm_bill, decimal ip_dc_id_trung_tam, DateTime ip_v_dat_tu_ngay, DateTime ip_v_dat_den_ngay)
    {
        CStoredProc v_store_proc = new CStoredProc("pr_BAO_CAO_TONG_HOP_BILL_BI_TRA_LAI_MAT_PHI_WEB_DETAIL");
        v_store_proc.addDecimalInputParam("@ID_TRUNG_TAM", ip_dc_id_trung_tam);
        v_store_proc.addDatetimeInputParam("@TU_NGAY", ip_v_dat_tu_ngay);
        v_store_proc.addDatetimeInputParam("@DEN_NGAY", ip_v_dat_den_ngay);
        v_store_proc.fillDataSetByCommand(this, ip_v_ds_v_dm_bill);
    ...
    public void Fill_DS_BAO_CAO_TONG_HOP_BILL_BI_TRA_LAI_KHONG_MAT_PHI_WEB_DETAIL(DS_V_DM_BILL ip_v_ds_v_dm_bill, decimal ip_dc_id_trung_tam, DateTime ip_v_dat_tu_ngay, DateTime ip_v_dat_den_ngay, string ip_nguoi_gui)
    {
        CStoredProc v_store_proc = new CStoredProc("pr_BAO_CAO_TONG_HOP_BILL_BI_TRA_LAI_KHONG_MAT_PHI_WEB_DETAIL_2");
        v_store_proc.addDecimalInputParam("@ID_TRUNG_TAM", ip_dc_id_trung_tam);
        v_store_proc.addDatetimeInputParam("@TU_NGAY", ip_v_dat_tu_ngay);
        v_store_proc.addDatetimeInputParam("@DEN_NGAY", ip_v_dat_den_ngay);
        v_store_proc.addNVarcharInputParam("@NGUOI_GUI", ip_nguoi_gui);
