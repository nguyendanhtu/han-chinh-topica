    ...
    public partial class DM_PHONG_BANTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[DM_PHONG_BAN] WHERE (([ID] = @Original_ID) AND ([MA_PHONG_BAN]" +
                " = @Original_MA_PHONG_BAN) AND ((@IsNull_TEN_PHONG_BAN = 1 AND [TEN_PHONG_BAN] I" +
                "S NULL) OR ([TEN_PHONG_BAN] = @Original_TEN_PHONG_BAN)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[DM_PHONG_BAN] SET [MA_PHONG_BAN] = @MA_PHONG_BAN, [TEN_PHONG_BAN] = @TEN_PHONG_BAN WHERE (([ID] = @Original_ID) AND ([MA_PHONG_BAN] = @Original_MA_PHONG_BAN) AND ((@IsNull_TEN_PHONG_BAN = 1 AND [TEN_PHONG_BAN] IS NULL) OR ([TEN_PHONG_BAN] = @Original_TEN_PHONG_BAN)));
