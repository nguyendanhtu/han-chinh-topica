...
namespace BCTKApp
{
	...
	public class f505_CAP_NHAT_TRANG_THAI_CPN : System.Windows.Forms.Form
	{
        ...
        private TextBox m_txt_phong_ban;
        private ComboBox m_cbo_trang_thai_cu;
		...
		private void InitializeComponent()
		{
            ...
            this.m_pnl_top.Controls.Add(this.m_txt_phong_ban);
            this.m_pnl_top.Controls.Add(this.m_cbo_trang_thai_cu);
            this.m_pnl_top.Controls.Add(this.label5);
            ...
            this.m_dtp_den_ngay.Location = new System.Drawing.Point(515, 40);
            ...
            this.m_dtp_den_ngay.TabIndex = 26;
            this.m_dtp_den_ngay.Value = new System.DateTime(2014, 6, 26, 9, 16, 54, 0);
            // 
            // m_dtp_tu_ngay
            // 
            ...
            this.m_dtp_tu_ngay.Location = new System.Drawing.Point(283, 40);
            ...
            this.m_dtp_tu_ngay.TabIndex = 25;
            this.m_dtp_tu_ngay.Value = new System.DateTime(2014, 6, 26, 9, 16, 54, 0);
            // 
            // label6
            // 
            this.label6.AutoSize = true;
            this.label6.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.label6.Location = new System.Drawing.Point(429, 44);
            ...
            this.Controls.Add(this.m_grv_cap_nhat_trang_thai);
            this.Controls.Add(this.m_pnl_out_place_dm);
            this.Name = "f505_CAP_NHAT_TRANG_THAI_CPN";
            this.Text = "F505-Cập nhật trạng thái CPN";
            this.Load += new System.EventHandler(this.f505_CAP_NHAT_TRANG_THAI_CPN_Load);
            this.m_pnl_out_place_dm.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)(this.m_grv_cap_nhat_trang_thai)).EndInit();
		...
		private void set_initial_form_load(){						
			m_obj_trans = get_trans_object(m_grv_cap_nhat_trang_thai);
			load_data_2_grid();		
		}	
		...
		private void grid2us_object(US_V_DM_BILL i_us
			, int i_grid_row) {
			DataRow v_dr;
			v_dr = (DataRow) m_grv_cap_nhat_trang_thai.Rows[i_grid_row].UserData;
		...
		private void us_object2grid(US_V_DM_BILL i_us
			, int i_grid_row) {
			DataRow v_dr = (DataRow) m_grv_cap_nhat_trang_thai.Rows[i_grid_row].UserData;
		...
		private void update_v_dm_bill(){			
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_grv_cap_nhat_trang_thai)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_grv_cap_nhat_trang_thai, m_grv_cap_nhat_trang_thai.Row)) return;			
		...
		private void delete_v_dm_bill(){
			...
			grid2us_object(v_us, m_grv_cap_nhat_trang_thai.Row);
			try {			
				v_us.BeginTransaction();    											
				v_us.Delete();                      								
				v_us.CommitTransaction();
				m_grv_cap_nhat_trang_thai.Rows.Remove(m_grv_cap_nhat_trang_thai.Row);				
			}
			catch (Exception v_e) {
				v_us.Rollback();
