...
/// Date: 09/10/2012 07:09:50
/// Goal: Create Form for HT_THAM_SO_HE_THONG
///************************************************
...
namespace BCTKApp
{
	...
	public class f107_ht_tham_so_he_thong : System.Windows.Forms.Form
	{
		...
		public f107_ht_tham_so_he_thong()
		{
			//
...
,MA_THAM_SO = 3
		...
		DS_HT_THAM_SO_HE_THONG m_ds = new DS_HT_THAM_SO_HE_THONG();
		US_HT_THAM_SO_HE_THONG m_us = new US_HT_THAM_SO_HE_THONG();
		#endregion
		...
		private void grid2us_object(US_HT_THAM_SO_HE_THONG i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_HT_THAM_SO_HE_THONG i_us
			, int i_grid_row) {
		...
		private void view_ht_tham_so_he_thong(){			
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
			grid2us_object(m_us, m_fg.Row);
		...
		private void set_define_events(){
            ...
            this.KeyDown += new KeyEventHandler(f107_ht_tham_so_he_thong_KeyDown);
		}

        void f107_ht_tham_so_he_thong_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
