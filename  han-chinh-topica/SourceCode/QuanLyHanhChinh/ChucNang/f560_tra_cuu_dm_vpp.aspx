...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#<%=m_cbo_tim_kiem.ClientID%>").select2();
        });
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <table cellspacing="0" cellpadding="2" style="width: 100%" class="cssTable" border="0">
        ...
        <tr>
            <td align="center" colspan="4">
                <asp:Label ID="m_lbl_nha_cc" runat="server" Text="Nhà cung cấp" Width="150px" CssClass="cssManField"></asp:Label>
                <asp:DropDownList ID="m_cbo_nha_cc" runat="server" CssClass="cssDorpdownlistDefault" Width="37%">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td align="center" colspan="4">
                <asp:Label ID="Label2" runat="server" Text="Nhập tên VPP " Width="150px" CssClass="cssManField"></asp:Label>
                <asp:DropDownList ID="m_cbo_tim_kiem" runat="server" Width="30%"></asp:DropDownList>
                &nbsp;
                        <asp:Button ID="m_cmd_tim_kiem" runat="server" Text="Tìm kiếm" CssClass="cssGoogleButton" Width="6%" CausesValidation="false" OnClick="m_cmd_tim_kiem_Click" />
            </td>
        </tr>
        <tr>
            <td>
