...
/// Date: 25/06/2014 09:58:05
/// Goal: Create User Service Class for GD_THONG_KE
///************************************************
/// <summary>
/// Create User Service Class for GD_THONG_KE
/// </summary>
...
public class US_GD_THONG_KE : US_Object
{
	private const string c_TableName = "GD_THONG_KE";
...
#region "Init Functions"
	public US_GD_THONG_KE() 
	{
		pm_objDS = new DS_GD_THONG_KE();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_GD_THONG_KE(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_GD_THONG_KE(decimal i_dbID) 
	{
		pm_objDS = new DS_GD_THONG_KE();
		pm_strTableName = c_TableName;
