    ...
    <table cellspacing="0" cellpadding="2" style="width: 100%" class="cssTable" border="0">
        <tr>
            <td align="center" colspan="4">
                <asp:Label ID="m_lbl_header" runat="server" Text="ĐĂNG KÍ GỬI BILL LẺ" CssClass="cssManField" Font-Bold="true" Font-Size="X-Large"></asp:Label>
                <asp:HiddenField ID="m_hdf_id_trung_tam" runat="server" />
            </td>
        </tr>
        <tr>
            <td colspan="4" align="center">
                <asp:Label ID="m_lbl_ten_trung_tam" runat="server" ForeColor="GrayText" Font-Bold="true" Font-Size="Medium"></asp:Label>
            </td>
        </tr>
        <tr>
        </tr>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <asp:TextBox ID="m_txt_tim_kiem" runat="server" Width="400px" Height="20px" CssClass="cssTextBox" placeholder="Nhập số Bill, người nhận, nơi nhận, người gửi"></asp:TextBox>
                                &nbsp;
