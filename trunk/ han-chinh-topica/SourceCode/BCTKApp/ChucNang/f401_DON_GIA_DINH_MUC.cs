///************************************************
/// Generated by: HuyTD
/// Date: 27/06/2014 09:20:38
/// Goal: Create Form for V_BANG_CO_SO_DINH_MUC
///************************************************
...
namespace BCTKApp
{
	...
	public class f401_DON_GIA_DINH_MUC : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f401_DON_GIA_DINH_MUC));
            ...
            this.m_dat_ngay_ap_dung.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.m_dat_ngay_ap_dung.Format = System.Windows.Forms.DateTimePickerFormat.Short;
            this.m_dat_ngay_ap_dung.Location = new System.Drawing.Point(399, 15);
            this.m_dat_ngay_ap_dung.Name = "m_dat_ngay_ap_dung";
            this.m_dat_ngay_ap_dung.Size = new System.Drawing.Size(200, 20);
            ...
            // panel1
            // 
            this.panel1.Controls.Add(this.m_dat_ngay_ap_dung);
...
,PM_DON_VI = 7
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(V_BANG_CO_SO_DINH_MUC.NHAN_VIEN_DON_VI, e_col_Number.NHAN_VIEN_DON_VI);
			v_htb.Add(V_BANG_CO_SO_DINH_MUC.TD_DON_VI, e_col_Number.TD_DON_VI);
			v_htb.Add(V_BANG_CO_SO_DINH_MUC.SD_CC, e_col_Number.SD_CC);
			v_htb.Add(V_BANG_CO_SO_DINH_MUC.HOC_VIEN_TUYEN_MOI, e_col_Number.HOC_VIEN_TUYEN_MOI);
			v_htb.Add(V_BANG_CO_SO_DINH_MUC.HOC_VIEN_DANG_HOC, e_col_Number.HOC_VIEN_DANG_HOC);
		...
		private void us_object2grid(US_V_BANG_CO_SO_DINH_MUC i_us
			, int i_grid_row) {
		...
		private void insert_v_bang_co_so_dinh_muc(){			
		...
		private void delete_v_bang_co_so_dinh_muc(){
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
			if (BaseMessages.askUser_DataCouldBeDeleted(8) != BaseMessages.IsDataCouldBeDeleted.CouldBeDeleted)  return;
			US_V_BANG_CO_SO_DINH_MUC v_us = new US_V_BANG_CO_SO_DINH_MUC();
