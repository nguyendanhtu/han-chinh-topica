...
namespace BCTKApp
{
	...
	public class f528_DM_NHA_CC : System.Windows.Forms.Form
	{
		internal System.Windows.Forms.ImageList ImageList;
		internal System.Windows.Forms.Panel m_pnl_out_place_dm;
		private C1.Win.C1FlexGrid.C1FlexGrid m_grv_nha_cc;
		...
		private void InitializeComponent()
		{
            ...
            this.m_pnl_out_place_dm.Size = new System.Drawing.Size(647, 36);
            ...
            this.m_cmd_insert.Location = new System.Drawing.Point(291, 4);
            ...
            this.m_cmd_delete.Location = new System.Drawing.Point(467, 4);
            ...
            this.m_cmd_exit.Location = new System.Drawing.Point(555, 4);
            ...
            this.m_grv_nha_cc.Size = new System.Drawing.Size(647, 330);
            ...
            this.panel1.Size = new System.Drawing.Size(647, 98);
            ...
            this.m_lbl_tieu_de.Size = new System.Drawing.Size(647, 26);
		...
		private void format_controls(){
			...
			CControlFormat.setC1FlexFormat(m_grv_nha_cc);
			CGridUtils.AddSave_Excel_Handlers(m_grv_nha_cc);
            			CGridUtils.AddSearch_Handlers(m_grv_nha_cc);
			set_define_events();
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(DM_NHA_CUNG_CAP.WEB, e_col_Number.WEB);			v_htb.Add(DM_NHA_CUNG_CAP.FAX, e_col_Number.FAX);			v_htb.Add(DM_NHA_CUNG_CAP.DIA_CHI, e_col_Number.DIA_CHI);			v_htb.Add(DM_NHA_CUNG_CAP.DIEN_THOAI, e_col_Number.DIEN_THOAI);			v_htb.Add(DM_NHA_CUNG_CAP.EMAIL, e_col_Number.EMAIL);			v_htb.Add(DM_NHA_CUNG_CAP.TEN, e_col_Number.TEN);									
		...
		private void load_data_2_grid(){						
			...
			m_grv_nha_cc.Redraw = false;
			CGridUtils.Dataset2C1Grid(m_ds, m_grv_nha_cc, m_obj_trans);
			m_grv_nha_cc.Redraw = true;
		}
		...
		private void us_object2grid(US_DM_NHA_CUNG_CAP i_us
			, int i_grid_row) {
			DataRow v_dr = (DataRow) m_grv_nha_cc.Rows[i_grid_row].UserData;
		...
		//	f528_DM_NHA_CC_DE v_fDE = new  f528_DM_NHA_CC_DE();								
		//	v_fDE.display();
			load_data_2_grid();
		}
		...
		private void update_dm_nha_cung_cap(){			
			...
			grid2us_object(m_us, m_grv_nha_cc.Row);
		//	f528_DM_NHA_CC_DE v_fDE = new f528_DM_NHA_CC_DE();
		//	v_fDE.display(m_us);
			load_data_2_grid();
		}
...
//
		...
		//
		//
		private void f528_DM_NHA_CC_Load(object sender, System.EventArgs e) {
			try{
