                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="OtherNews_td">
                                                    <a href="/QuanLyHanhChinh/ChucNang/F101_QuanLyDat.aspx" style="font-weight: bold">Quản lý danh sách đất</a>
                                                    <br>
                                ...
                                <td>
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tbody>
                                            <tr>
                                                <td class="OtherNews_td">
                                                    <a class="link_OtherNews" href="/QuanLyHanhChinh/ChucNang/F104_DeNghiXuLyDat.aspx" style="font-weight: bold">Đề nghị xử lý đất</a>
                                                    <br>
                                ...
                                <td>
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tbody>
                                            <tr>
                                                <td class="OtherNews_td">
                                                    <a class="link_OtherNews" href="/QuanLyHanhChinh/ChucNang/F105_KhauHaoDat.aspx" style="font-weight: bold">Khấu hao đất</a>
                                                    <br>
