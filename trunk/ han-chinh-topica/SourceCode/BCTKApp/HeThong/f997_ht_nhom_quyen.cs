///************************************************
/// Generated by: NinhVH
/// Date: 26/11/2012 03:22:40
/// Goal: Create Form for HT_NHOM_NGUOI_SU_DUNG
///************************************************
...
namespace BCTKApp
{
	...
	public class f997_ht_nhom_quyen : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f997_ht_nhom_quyen));
...
,LAS_UPDATED_DATE = 6
		...
		DS_HT_NHOM_NGUOI_SU_DUNG m_ds = new DS_HT_NHOM_NGUOI_SU_DUNG();
		US_HT_NHOM_NGUOI_SU_DUNG m_us = new US_HT_NHOM_NGUOI_SU_DUNG();
		#endregion
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(HT_NHOM_NGUOI_SU_DUNG.ID, e_col_Number.ID);
			v_htb.Add(HT_NHOM_NGUOI_SU_DUNG.ID_INPUTED_BY, e_col_Number.ID_INPUTED_BY);
			v_htb.Add(HT_NHOM_NGUOI_SU_DUNG.MA_NHOM, e_col_Number.MA_NHOM);
			v_htb.Add(HT_NHOM_NGUOI_SU_DUNG.ID_LAST_UPDATED_BY, e_col_Number.ID_LAST_UPDATED_BY);
			v_htb.Add(HT_NHOM_NGUOI_SU_DUNG.GHI_CHU, e_col_Number.GHI_CHU);
			v_htb.Add(HT_NHOM_NGUOI_SU_DUNG.TRANG_THAI_NHOM, e_col_Number.TRANG_THAI_NHOM);
			v_htb.Add(HT_NHOM_NGUOI_SU_DUNG.INPUTED_DATE, e_col_Number.INPUTED_DATE);
			v_htb.Add(HT_NHOM_NGUOI_SU_DUNG.LAS_UPDATED_DATE, e_col_Number.LAS_UPDATED_DATE);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_ds.HT_NHOM_NGUOI_SU_DUNG.NewRow());
			return v_obj_trans;			
		}
		...
		private void us_object2grid(US_HT_NHOM_NGUOI_SU_DUNG i_us
			, int i_grid_row) {
		...
		private void insert_ht_nhom_nguoi_su_dung(){			
		    f997_ht_nhom_quyen_de v_fDE = new  f997_ht_nhom_quyen_de();								
		    v_fDE.insert_new_user();
			load_data_2_grid();
		}

		private void update_ht_nhom_nguoi_su_dung(){			
		...
		private void delete_ht_nhom_nguoi_su_dung(){
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
			if (BaseMessages.askUser_DataCouldBeDeleted(8) != BaseMessages.IsDataCouldBeDeleted.CouldBeDeleted)  return;
			US_HT_NHOM_NGUOI_SU_DUNG v_us = new US_HT_NHOM_NGUOI_SU_DUNG();
		...
		private void view_ht_nhom_nguoi_su_dung(){			
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
			grid2us_object(m_us, m_fg.Row);
		//	f997_ht_nhom_quyen_DE v_fDE = new f997_ht_nhom_quyen_DE();			
...
//
		...
		//
		//
		private void f997_ht_nhom_quyen_Load(object sender, System.EventArgs e) {
			try{
