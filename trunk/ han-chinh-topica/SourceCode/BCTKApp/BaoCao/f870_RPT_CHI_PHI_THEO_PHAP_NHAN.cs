...
/// Date: 13/07/2014 11:59:46
/// Goal: Create Form for RPT_CHI_PHI_THEO_PHAP_NHAN
///************************************************
...
namespace BCTKApp
{
	...
	public class f870_RPT_CHI_PHI_THEO_PHAP_NHAN : System.Windows.Forms.Form
	{
		...
		public f870_RPT_CHI_PHI_THEO_PHAP_NHAN()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            this.m_pnl_out_place_dm.Location = new System.Drawing.Point(0, 283);
            this.m_pnl_out_place_dm.Name = "m_pnl_out_place_dm";
            this.m_pnl_out_place_dm.Padding = new System.Windows.Forms.Padding(4);
            this.m_pnl_out_place_dm.Size = new System.Drawing.Size(503, 36);
            ...
            this.m_cmd_insert.Location = new System.Drawing.Point(147, 4);
            ...
            this.m_cmd_update.Location = new System.Drawing.Point(235, 4);
            ...
            this.m_cmd_delete.Location = new System.Drawing.Point(323, 4);
            ...
            this.m_cmd_exit.Location = new System.Drawing.Point(411, 4);
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(503, 192);
            ...
            this.m_lbl_tieu_de.Size = new System.Drawing.Size(503, 31);
            ...
            this.m_pnl.Size = new System.Drawing.Size(503, 60);
            ...
            this.m_cmd_tim_kiem.Location = new System.Drawing.Point(354, 1);
            ...
            this.m_dat_den_ngay.Location = new System.Drawing.Point(131, 29);
            ...
            this.m_dat_tu_ngay.Location = new System.Drawing.Point(131, 3);
...
,TEN_PHAP_NHAN = 2
		...
		DS_RPT_CHI_PHI_THEO_PHAP_NHAN m_ds = new DS_RPT_CHI_PHI_THEO_PHAP_NHAN();
		US_RPT_CHI_PHI_THEO_PHAP_NHAN m_us = new US_RPT_CHI_PHI_THEO_PHAP_NHAN();
		#endregion
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(RPT_CHI_PHI_THEO_PHAP_NHAN.MA_PHAP_NHAN, e_col_Number.MA_PHAP_NHAN);
			v_htb.Add(RPT_CHI_PHI_THEO_PHAP_NHAN.TONG_TIEN, e_col_Number.TONG_TIEN);
			v_htb.Add(RPT_CHI_PHI_THEO_PHAP_NHAN.TEN_PHAP_NHAN, e_col_Number.TEN_PHAP_NHAN);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_ds.RPT_CHI_PHI_THEO_PHAP_NHAN.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){						
			m_ds = new DS_RPT_CHI_PHI_THEO_PHAP_NHAN();			
			m_us.fillDatasetByProc(m_ds, m_dat_tu_ngay.Value, m_dat_den_ngay.Value);
			m_fg.Redraw = false;
			CGridUtils.Dataset2C1Grid(m_ds, m_fg, m_obj_trans);
			m_fg.Redraw = true;
		}
		private void grid2us_object(US_RPT_CHI_PHI_THEO_PHAP_NHAN i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_RPT_CHI_PHI_THEO_PHAP_NHAN i_us
			, int i_grid_row) {
		...
		private void insert_rpt_chi_phi_theo_phap_nhan(){			
		//	f870_RPT_CHI_PHI_THEO_PHAP_NHAN_DE v_fDE = new  f870_RPT_CHI_PHI_THEO_PHAP_NHAN_DE();								
		//	v_fDE.display();
			load_data_2_grid();
		}

		private void update_rpt_chi_phi_theo_phap_nhan(){			
		...
		private void delete_rpt_chi_phi_theo_phap_nhan(){
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
			if (BaseMessages.askUser_DataCouldBeDeleted(8) != BaseMessages.IsDataCouldBeDeleted.CouldBeDeleted)  return;
			US_RPT_CHI_PHI_THEO_PHAP_NHAN v_us = new US_RPT_CHI_PHI_THEO_PHAP_NHAN();
		...
		private void view_rpt_chi_phi_theo_phap_nhan(){			
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
			grid2us_object(m_us, m_fg.Row);
		//	f870_RPT_CHI_PHI_THEO_PHAP_NHAN_DE v_fDE = new f870_RPT_CHI_PHI_THEO_PHAP_NHAN_DE();			
...
//
		...
		//
		//
		private void f870_RPT_CHI_PHI_THEO_PHAP_NHAN_Load(object sender, System.EventArgs e) {
			try{
		...
		private void m_cmd_insert_Click(object sender, EventArgs e) {
			try{
				insert_rpt_chi_phi_theo_phap_nhan();
			}
			catch (Exception v_e){
				CSystemLog_301.ExceptionHandle(v_e);
			}
		...
		private void m_cmd_update_Click(object sender, EventArgs e) {
			try{
				update_rpt_chi_phi_theo_phap_nhan();
			}
			catch (Exception v_e){
				CSystemLog_301.ExceptionHandle(v_e);
			}
		...
		private void m_cmd_delete_Click(object sender, EventArgs e) {
			try{
				delete_rpt_chi_phi_theo_phap_nhan();
			}
			catch (Exception v_e){
				CSystemLog_301.ExceptionHandle(v_e);
			}
		...
		private void m_cmd_view_Click(object sender, EventArgs e) {
			try{
				view_rpt_chi_phi_theo_phap_nhan();
			}
			catch (Exception v_e){
				CSystemLog_301.ExceptionHandle(v_e);
			}
