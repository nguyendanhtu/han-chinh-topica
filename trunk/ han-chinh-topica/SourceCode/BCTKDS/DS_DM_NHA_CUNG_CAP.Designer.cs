...
namespace BCTKDS {
    ...
    public partial class DS_DM_NHA_CUNG_CAP : global::System.Data.DataSet {
        ...
        public partial class DM_NHA_CUNG_CAPDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DM_NHA_CUNG_CAPRow AddDM_NHA_CUNG_CAPRow(string TEN, string DIA_CHI, string DIEN_THOAI, string WEB, string EMAIL) {
    ...
    public partial class DM_NHA_CUNG_CAPTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[DM_NHA_CUNG_CAP] ([TEN], [DIA_CHI], [DIEN_THOAI], [WEB], [EMAI" +
                "L]) VALUES (@TEN, @DIA_CHI, @DIEN_THOAI, @WEB, @EMAIL);\r\nSELECT ID, TEN, DIA_CHI" +
                ", DIEN_THOAI, WEB, EMAIL FROM DM_NHA_CUNG_CAP WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[DM_NHA_CUNG_CAP] SET [TEN] = @TEN, [DIA_CHI] = @DIA_CHI, [DIEN_THOAI] = @DIEN_THOAI, [WEB] = @WEB, [EMAIL] = @EMAIL WHERE (([ID] = @Original_ID) AND ((@IsNull_TEN = 1 AND [TEN] IS NULL) OR ([TEN] = @Original_TEN)) AND ([DIA_CHI] = @Original_DIA_CHI) AND ((@IsNull_DIEN_THOAI = 1 AND [DIEN_THOAI] IS NULL) OR ([DIEN_THOAI] = @Original_DIEN_THOAI)) AND ((@IsNull_WEB = 1 AND [WEB] IS NULL) OR ([WEB] = @Original_WEB)) AND ((@IsNull_EMAIL = 1 AND [EMAIL] IS NULL) OR ([EMAIL] = @Original_EMAIL)));
SELECT ID, TEN, DIA_CHI, DIEN_THOAI, WEB, EMAIL FROM DM_NHA_CUNG_CAP WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, TEN, DIA_CHI, DIEN_THOAI, WEB, EMAIL FROM dbo.DM_NHA_CUNG_CAP";
        ...
        public virtual int Delete(decimal Original_ID, string Original_TEN, string Original_DIA_CHI, string Original_DIEN_THOAI, string Original_WEB, string Original_EMAIL) {
        ...
        public virtual int Insert(string TEN, string DIA_CHI, string DIEN_THOAI, string WEB, string EMAIL) {
            if ((TEN == null)) {
        ...
        public virtual int Update(string TEN, string DIA_CHI, string DIEN_THOAI, string WEB, string EMAIL, decimal Original_ID, string Original_TEN, string Original_DIA_CHI, string Original_DIEN_THOAI, string Original_WEB, string Original_EMAIL, decimal ID) {
            if ((TEN == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string TEN, string DIA_CHI, string DIEN_THOAI, string WEB, string EMAIL, decimal Original_ID, string Original_TEN, string Original_DIA_CHI, string Original_DIEN_THOAI, string Original_WEB, string Original_EMAIL) {
            return this.Update(TEN, DIA_CHI, DIEN_THOAI, WEB, EMAIL, Original_ID, Original_TEN, Original_DIA_CHI, Original_DIEN_THOAI, Original_WEB, Original_EMAIL, Original_ID);
        }
    }
