...
#region "Init Functions"
    ...
    public void Nhap_ma_hoa_don_NCC(DS_V_GD_DON_DAT_HANG m_ds, DateTime v_dt_tu_ngay, DateTime v_dt_den_ngay, decimal id_trang_thai, decimal id_phong_ban)
    {
        ...
        v_stored_proc.addDecimalInputParam("@ID_PHONG_BAN", id_phong_ban);
        v_stored_proc.fillDataSetByCommand(this, m_ds);
    }

    public void Loc_HD_da_co_ma_hoa_don_NCC(DS_V_GD_DON_DAT_HANG m_ds, DateTime v_dt_tu_ngay, DateTime v_dt_den_ngay, decimal id_trang_thai, decimal id_phong_ban)
    {
    ...
    public void Loc_HD_chua_co_ma_hoa_don_NCC(DS_V_GD_DON_DAT_HANG m_ds, DateTime v_dt_tu_ngay, DateTime v_dt_den_ngay, decimal id_trang_thai, decimal id_phong_ban)
    {
    ...
    public void FillDataset(DS_V_GD_DON_DAT_HANG ip_v_ds, decimal ip_v_id_trung_tam, DateTime ip_v_dt_tu_ngay, DateTime ip_v_dt_den_ngay)
    {
        CStoredProc v_stored_proc = new CStoredProc("pr_TRA_CUU_TINH_HINH_VPP_WEB_chi_tiet_Search");
    ...
    public void FillDatasetSearch_phap_nhan(DS_V_GD_DON_DAT_HANG ip_ds, DateTime ip_dat_thang, decimal ip_dc_id_phap_nhan, decimal ip_id_trang_thai, decimal ip_id_trung_tam)
    {
        CStoredProc v_stored_proc = new CStoredProc("pr_V_GD_DON_DAT_HANG_Search_Phapnhan");
