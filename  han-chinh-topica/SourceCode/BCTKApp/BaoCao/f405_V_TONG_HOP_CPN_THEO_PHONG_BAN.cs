...
,
        ...
        private void get_thoi_gian()
        {
            ...
            m_dt_tu_ngay.Text = starts.ToString("dd/MM/yyyy");
            m_dt_den_ngay.Text = today.ToString("dd/MM/yyyy");
        }
        ...
        private void m_cmd_xuat_excel_pn_pb_Click(object sender, EventArgs e)
        {
            try
            {
