...
Partial Public Class DS_HT_NGUOI_SU_DUNG
    ...
    Partial Public Class HT_NGUOI_SU_DUNGDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddHT_NGUOI_SU_DUNGRow(ByVal TEN_TRUY_CAP As String, ByVal TEN As String, ByVal MAT_KHAU As String, ByVal NGAY_TAO As Date, ByVal NGUOI_TAO As String, ByVal TRANG_THAI As String, ByVal BUILT_IN_YN As String, ByVal ID_USER_GROUP As Decimal, ByVal ID_TRAINING_PROJECT As Decimal) As HT_NGUOI_SU_DUNGRow
            Dim rowHT_NGUOI_SU_DUNGRow As HT_NGUOI_SU_DUNGRow = CType(Me.NewRow,HT_NGUOI_SU_DUNGRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, TEN_TRUY_CAP, TEN, MAT_KHAU, NGAY_TAO, NGUOI_TAO, TRANG_THAI, BUILT_IN_YN, ID_USER_GROUP, ID_TRAINING_PROJECT}
    ...
    Partial Public Class HT_NGUOI_SU_DUNGTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[HT_NGUOI_SU_DUNG] WHERE (([ID] = @Original_ID) AND ([TEN_TRUY_"& _ 
                ...
                "ROJECT] = @Original_ID_TRAINING_PROJECT)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[HT_NGUOI_SU_DUNG] ([TEN_TRUY_CAP], [TEN], [MAT_KHAU], [NGAY_TA"& _ 
                ...
                "ECT]) VALUES (@TEN_TRUY_CAP, @TEN, @MAT_KHAU, @NGAY_TAO, @NGUOI_TAO, @TRANG_THAI"& _ 
                ", @BUILT_IN_YN, @ID_USER_GROUP, @ID_TRAINING_PROJECT);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID, TEN_TRUY_CAP,"& _ 
                " TEN, MAT_KHAU, NGAY_TAO, NGUOI_TAO, TRANG_THAI, BUILT_IN_YN, ID_USER_GROUP, ID_"& _ 
                "TRAINING_PROJECT FROM HT_NGUOI_SU_DUNG WHERE (ID = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[HT_NGUOI_SU_DUNG] SET [TEN_TRUY_CAP] = @TEN_TRUY_CAP, [TEN] = @TEN,"& _ 
                ...
                "GROUP, [ID_TRAINING_PROJECT] = @ID_TRAINING_PROJECT WHERE (([ID] = @Original_ID)"& _ 
                " AND ([TEN_TRUY_CAP] = @Original_TEN_TRUY_CAP) AND ([TEN] = @Original_TEN) AND ("& _ 
                "[MAT_KHAU] = @Original_MAT_KHAU) AND ([NGAY_TAO] = @Original_NGAY_TAO) AND ([NGU"& _ 
                "OI_TAO] = @Original_NGUOI_TAO) AND ([TRANG_THAI] = @Original_TRANG_THAI) AND ([B"& _ 
                "UILT_IN_YN] = @Original_BUILT_IN_YN) AND ([ID_USER_GROUP] = @Original_ID_USER_GR"& _ 
                "OUP) AND ((@IsNull_ID_TRAINING_PROJECT = 1 AND [ID_TRAINING_PROJECT] IS NULL) OR"& _ 
                " ([ID_TRAINING_PROJECT] = @Original_ID_TRAINING_PROJECT)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID, TEN_TRUY"& _ 
                "_CAP, TEN, MAT_KHAU, NGAY_TAO, NGUOI_TAO, TRANG_THAI, BUILT_IN_YN, ID_USER_GROUP"& _ 
                ", ID_TRAINING_PROJECT FROM HT_NGUOI_SU_DUNG WHERE (ID = @ID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, TEN_TRUY_CAP, TEN, MAT_KHAU, NGAY_TAO, NGUOI_TAO, TRANG_THAI, BUILT_IN"& _ 
                "_YN, ID_USER_GROUP, ID_TRAINING_PROJECT FROM dbo.HT_NGUOI_SU_DUNG"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Decimal, ByVal Original_TEN_TRUY_CAP As String, ByVal Original_TEN As String, ByVal Original_MAT_KHAU As String, ByVal Original_NGAY_TAO As Date, ByVal Original_NGUOI_TAO As String, ByVal Original_TRANG_THAI As String, ByVal Original_BUILT_IN_YN As String, ByVal Original_ID_USER_GROUP As Decimal, ByVal Original_ID_TRAINING_PROJECT As Global.System.Nullable(Of Decimal)) As Integer
        ...
        Public Overloads Overridable Function Update( _
            ...
            If (Original_TEN_TRUY_CAP Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_TEN_TRUY_CAP")
            Else
                Me.Adapter.UpdateCommand.Parameters(10).Value = CType(Original_TEN_TRUY_CAP,String)
            End If
            If (Original_TEN Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_TEN")
            Else
            ...
            If (Original_MAT_KHAU Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_MAT_KHAU")
            Else
                Me.Adapter.UpdateCommand.Parameters(12).Value = CType(Original_MAT_KHAU,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(13).Value = CType(Original_NGAY_TAO,Date)
            If (Original_NGUOI_TAO Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_NGUOI_TAO")
            Else
                Me.Adapter.UpdateCommand.Parameters(14).Value = CType(Original_NGUOI_TAO,String)
            End If
            If (Original_TRANG_THAI Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_TRANG_THAI")
            Else
                Me.Adapter.UpdateCommand.Parameters(15).Value = CType(Original_TRANG_THAI,String)
            End If
            If (Original_BUILT_IN_YN Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_BUILT_IN_YN")
            Else
                Me.Adapter.UpdateCommand.Parameters(16).Value = CType(Original_BUILT_IN_YN,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(17).Value = CType(Original_ID_USER_GROUP,Decimal)
            If (Original_ID_TRAINING_PROJECT.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(18).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(19).Value = CType(Original_ID_TRAINING_PROJECT.Value,Decimal)
            Else
                Me.Adapter.UpdateCommand.Parameters(18).Value = CType(1,Object)
                Me.Adapter.UpdateCommand.Parameters(19).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.UpdateCommand.Parameters(20).Value = CType(ID,Decimal)
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_BUILT_IN_YN As String,  _
                    ByVal Original_ID_USER_GROUP As Decimal,  _
                    ByVal Original_ID_TRAINING_PROJECT As Global.System.Nullable(Of Decimal)) As Integer
            Return Me.Update(TEN_TRUY_CAP, TEN, MAT_KHAU, NGAY_TAO, NGUOI_TAO, TRANG_THAI, BUILT_IN_YN, ID_USER_GROUP, ID_TRAINING_PROJECT, Original_ID, Original_TEN_TRUY_CAP, Original_TEN, Original_MAT_KHAU, Original_NGAY_TAO, Original_NGUOI_TAO, Original_TRANG_THAI, Original_BUILT_IN_YN, Original_ID_USER_GROUP, Original_ID_TRAINING_PROJECT, Original_ID)
        End Function
    End Class
End Namespace
