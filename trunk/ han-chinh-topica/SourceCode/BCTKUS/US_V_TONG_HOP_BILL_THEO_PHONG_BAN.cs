///************************************************
/// Generated by: HuyTD
/// Date: 29/06/2014 09:50:04
/// Goal: Create User Service Class for V_TONG_HOP_BILL_THEO_PHONG_BAN
///************************************************
/// <summary>
/// Create User Service Class for V_TONG_HOP_BILL_THEO_PHONG_BAN
/// </summary>
...
public class US_V_TONG_HOP_BILL_THEO_PHONG_BAN : US_Object
{
	private const string c_TableName = "V_TONG_HOP_BILL_THEO_PHONG_BAN";
...
#region "Init Functions"
	public US_V_TONG_HOP_BILL_THEO_PHONG_BAN() 
	{
		pm_objDS = new DS_V_TONG_HOP_BILL_THEO_PHONG_BAN();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_V_TONG_HOP_BILL_THEO_PHONG_BAN(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_V_TONG_HOP_BILL_THEO_PHONG_BAN(decimal i_dbID) 
	{
		pm_objDS = new DS_V_TONG_HOP_BILL_THEO_PHONG_BAN();
		pm_strTableName = c_TableName;
    ...
    public void FillDatasetSearch(DS_V_TONG_HOP_BILL_THEO_PHONG_BAN ip_v_ds, DateTime ip_v_dt_tu_ngay, DateTime ip_v_dt_den_ngay, decimal ip_v_id_trang_thai, string ip_v_id_tu_khoa)
    {
