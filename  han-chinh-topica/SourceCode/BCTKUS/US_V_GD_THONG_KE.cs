...
#endregion
    public void FillDatasetSearch(DS_V_GD_THONG_KE ip_m_ds,string ip_v_str_tim_kiem,DateTime ip_dat_tu_ngay,DateTime ip_dat_den_ngay, decimal ip_id_loai_dinh_muc)
    {
