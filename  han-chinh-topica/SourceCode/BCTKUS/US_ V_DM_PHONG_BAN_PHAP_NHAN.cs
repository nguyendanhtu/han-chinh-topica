...
public class US_ V_DM_PHONG_BAN_PHAP_NHAN : US_Object
{
...
#region "Init Functions"
	public US_ V_DM_PHONG_BAN_PHAP_NHAN() 
	{
		pm_objDS = new DS_ V_DM_PHONG_BAN_PHAP_NHAN();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_ V_DM_PHONG_BAN_PHAP_NHAN(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_ V_DM_PHONG_BAN_PHAP_NHAN(decimal i_dbID) 
	{
		pm_objDS = new DS_ V_DM_PHONG_BAN_PHAP_NHAN();
		pm_strTableName = c_TableName;
