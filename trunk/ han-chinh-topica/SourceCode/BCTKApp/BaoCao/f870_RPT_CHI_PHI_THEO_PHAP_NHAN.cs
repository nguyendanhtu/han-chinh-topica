...
namespace BCTKApp
{
	...
	public class f870_RPT_CHI_PHI_THEO_PHAP_NHAN : System.Windows.Forms.Form
	{
        ...
        private TCDatetime m_dat_den_ngay;
        private TCDatetime m_dat_tu_ngay;
...
,TEN_PHAP_NHAN = 2
		...
		private void load_data_2_grid(){
            DateTime v_dat_tu_ngay = CIPConvert.ToDatetime(m_dat_tu_ngay.Text, "dd/MM/yyyy");
            DateTime v_dat_den_ngay = CIPConvert.ToDatetime(m_dat_den_ngay.Text.Trim(), "dd/MM/yyyy");			
			m_ds = new DS_RPT_CHI_PHI_THEO_PHAP_NHAN();			
			m_us.fillDatasetByProc(m_ds, v_dat_tu_ngay, v_dat_den_ngay);
			m_fg.Redraw = false;
...
//
        ...
        private void m_fg_DoubleClick(object sender, EventArgs e) {
            try {
                ...
                DataRow v_dr = (DataRow)m_fg.Rows[m_fg.Row].UserData;
                Decimal v_id_phap_nhan = CIPConvert.ToDecimal(v_dr["ID_PHAP_NHAN"]);

                f871_RPT_CHI_TIET_CHI_PHI_PHAP_NHAN v_frm = new f871_RPT_CHI_TIET_CHI_PHI_PHAP_NHAN();
                v_frm.display(v_id_phap_nhan, v_dat_tu_ngay, v_dat_den_ngay);
            }
            catch(Exception v_e) {
