///************************************************
/// Generated by: HuyTD
/// Date: 08/09/2014 04:17:54
/// Goal: Create User Service Class for V_TONG_HOP_CPN_THEO_PHONG_BAN_PN
///************************************************
/// <summary>
/// Create User Service Class for V_TONG_HOP_CPN_THEO_PHONG_BAN_PN
/// </summary>
...
public class US_V_TONG_HOP_CPN_THEO_PHONG_BAN_PN : US_Object
{
	private const string c_TableName = "V_TONG_HOP_CPN_THEO_PHONG_BAN_PN";
...
#region "Init Functions"
	public US_V_TONG_HOP_CPN_THEO_PHONG_BAN_PN() 
	{
		pm_objDS = new DS_V_TONG_HOP_CPN_THEO_PHONG_BAN_PN();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_V_TONG_HOP_CPN_THEO_PHONG_BAN_PN(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_V_TONG_HOP_CPN_THEO_PHONG_BAN_PN(decimal i_dbID) 
	{
		pm_objDS = new DS_V_TONG_HOP_CPN_THEO_PHONG_BAN_PN();
		pm_strTableName = c_TableName;
    ...
    public void FillDatasetSearch(DS_V_TONG_HOP_CPN_THEO_PHONG_BAN_PN ip_v_ds, string ip_v_str_tu_khoa, decimal ip_v_id_phap_nhan, DateTime ip_v_dt_tu_ngay, DateTime ip_v_dt_den_ngay, decimal ip_v_id_trang_thai)
    {
        CStoredProc v_stored_proc = new CStoredProc("pr_V_TONG_HOP_CPN_THEO_PHONG_BAN_PN_Search");
