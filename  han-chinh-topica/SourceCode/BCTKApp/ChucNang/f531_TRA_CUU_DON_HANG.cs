...
namespace BCTKApp
{
	...
	public class f531_TRA_CUU_DON_HANG : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f531_TRA_CUU_DON_HANG));
            ...
            this.m_pnl_out_place_dm.Size = new System.Drawing.Size(841, 36);
            ...
            this.m_cmd_update.Location = new System.Drawing.Point(573, 4);
            ...
            this.m_cmd_delete.Location = new System.Drawing.Point(661, 4);
            ...
            this.m_cmd_exit.Location = new System.Drawing.Point(749, 4);
            ...
            this.m_grv_don_hang.Location = new System.Drawing.Point(0, 164);
            this.m_grv_don_hang.Name = "m_grv_don_hang";
            this.m_grv_don_hang.Size = new System.Drawing.Size(841, 362);
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(631, 113);
            ...
            // m_txt_tu_khoa
            // 
            this.m_txt_tu_khoa.Location = new System.Drawing.Point(309, 121);
            this.m_txt_tu_khoa.Name = "m_txt_tu_khoa";
            this.m_txt_tu_khoa.Size = new System.Drawing.Size(299, 20);
            this.m_txt_tu_khoa.TabIndex = 37;
            // 
            // label2
            // 
            ...
            this.m_lbl_tieu_de.Size = new System.Drawing.Size(841, 32);
		...
		private void format_controls(){
            ...
            m_grv_don_hang.Tree.Column = (int)e_col_Number.LAN_DAT_HANG;
            m_grv_don_hang.Cols[(int)e_col_Number.TEN_PHONG_BAN].Visible = false;
            m_grv_don_hang.Cols[(int)e_col_Number.NGAY_DAT_HANG].Visible = false;
		...
		private void load_data_2_grid(){
			...
			m_us.FillDatasetSearch(m_ds,v_dat_thang,v_dc_id_trung_tam,v_str_tu_khoa);
            ...
            m_grv_don_hang.Subtotal(C1.Win.C1FlexGrid.AggregateEnum.Count // chỗ này dùng hàm count tức là để đếm, có thể dùng các hàm khác thay thế
              , 1
              , (int)e_col_Number.NGAY_DAT_HANG // chỗ này là tên trường mà mình nhóm
              , (int)e_col_Number.LAN_DAT_HANG // chỗ này là tên trường mà mình Count
              , "{0}"
              );
...
//
        ...
        //
        #region Event
        private void f531_TRA_CUU_DON_HANG_Load(object sender, System.EventArgs e)
        {
            try
            {
