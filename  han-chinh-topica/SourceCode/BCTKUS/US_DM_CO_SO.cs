///************************************************
/// Generated by: DungNT
/// Date: 12/07/2014 10:59:08
/// Goal: Create User Service Class for DM_CO_SO
///************************************************
/// <summary>
/// Create User Service Class for DM_CO_SO
/// </summary>
...
public class US_DM_CO_SO : US_Object
{
	private const string c_TableName = "DM_CO_SO";
...
#region "Init Functions"
	public US_DM_CO_SO() 
	{
		pm_objDS = new DS_DM_CO_SO();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_DM_CO_SO(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_DM_CO_SO(decimal i_dbID) 
	{
		pm_objDS = new DS_DM_CO_SO();
		pm_strTableName = c_TableName;
