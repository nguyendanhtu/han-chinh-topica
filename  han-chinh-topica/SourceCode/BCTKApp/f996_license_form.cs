...
namespace BCTKApp
{
	...
	public class f996_license_form : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.label4.Text = "Sản phẩm này nằm trong bộ sản phẩm ứng dụng dành cho tổ chức quản lý cấp phát chứ" +
                "ng chỉ";
            // 
            // m_cmd_tro_ve
            // 
            ...
            this.linkLabel1.Text = "Email: lindh2@topica.edu.vn";
            // 
            // pictureBox1
            // 
		...
		private void set_define_events(){
            ...
            this.KeyDown += new KeyEventHandler(f996_license_form_KeyDown);
		}

        void f996_license_form_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
